...
The BNF grammar is given in listing \ref{l:asl_grammar}.
...
\begin{bnflisting}
    ...
    <binExpr>  := <boolLit> 
                ...
                | "!" <binExpr>
    <boolLit>  := "true" | "false"
    <vLiteral> := <identifier> | <boolLit> | <digit>*
    <case>     := <binExpr> ":" <valExpr> ";"
    <caseStmt> := "case" "{" <case>* "}"
    <valExpr>  := <caseStmt> | <vLiteral>
    ...
    <spec>     := "State" <varDecl>* 
                  ...
                  "Transitions" <update>*
\end{bnflisting}
\caption{Specification language grammar}
\label{l:asl_grammar}
\end{figure}
