...
The last remaining step of the approximate three valued abstraction-refinement algorithm is checking whether the winning set contains the initial set. This check is performed for each winning set in Algorithm \ref{alg:approx_three_val}. Again, predicate abstraction complicates things as the following example shows.
