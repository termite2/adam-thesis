...
It addresses the scalability challenge with a new scalable synthesis engine which enables it to handle real-world device specifications that are beyond the reach of existing synthesis techniques. This thesis presents the predicate-based abstraction-refinement engine at the heart of Termite. We develop solutions to the three key problems involved in the implementation of efficient predicate abstraction which have not been addressed previously in a synthesis settings: (1) keeping abstractions concise by identifying relevant predicates only, (2) solving abstract games efficiently, (3) and computing abstractions symbolically. 
