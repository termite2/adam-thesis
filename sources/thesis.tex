...
The scalability challenge is to overcome the performance bottleneck of existing synthesis algorithms that are not able to efficiently handle real-world device specifications.  I address this challenge with a new scalable synthesis engine based on predicate-based abstraction refinement.  Solutions are developed to the three key problems involved in the implementation of efficient predicate abstraction which have not been addressed previously in a synthesis setting: (1) keeping abstractions concise by identifying relevant predicates only, (2) solving abstract games efficiently, (3) and computing abstractions symbolically. 
