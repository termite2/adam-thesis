...
As a prelude to what is coming, we could create a crude formalism for driver synthesis using only reachability games. Consider, for example the simple UART given in figure x. Explain how getting to the goal is a reachability game.
