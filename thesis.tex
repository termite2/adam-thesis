...
\subsubsection{Safety and reachability games}
...
\subsubsection{Strategies, counterexamples}
...
\subsubsection{Buchi, fairness and GR(1) games}
...
\subsubsection{Solving games}

\subsubsection{Extracting strategies}

\subsubsection{Extracting counterexamples}


\subsection{Symbolic games}
...
\subsubsection{Extension to GR(1) games and correctness proof}
...
\subsection{Heuristic code generation}
